<?php 
	...
	$sql_kriteria = "SELECT * FROM tb_penilaian 
	...
	<div class="container mt-5 mb-5 text-white">
		<div class="row justify-content-center">
			<div class="col-md-6 rounded" style="background-color: #CD1818;">
				<form method="POST">
					<h3 class="mt-3">UBAH PENILAIAN</h3>
					...
					<div class="form-group">
						...
						<input type="number" name="nilai[]" class="form-control" min="1" max="5" value="<?= $data['nilai']; ?>" required>
					</div>
					<?php endwhile ?>
					<div class="form-group">
